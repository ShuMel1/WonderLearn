...
object AppStrings {
  ...
  val lock_ios_guide = LocalizedString(mapOf(Language.ARMENIAN to "iPhone-ում միացրու Guided Access-ը Կարգավորումներ → Հատուկ հնարավորություններ, ապա եռակի սեղմիր կողային կոճակը՝ էկրանը այս հավելվածում կողպելու համար։", Language.ENGLISH to "On iPhone, turn on Guided Access in Settings → Accessibility, then triple-click the side button to lock the screen to this app.", Language.RUSSIAN to "На iPhone включи «Гид-доступ» в Настройки → Универсальный доступ, затем тройным нажатием боковой кнопки заблокируй экран на этом приложении."))
